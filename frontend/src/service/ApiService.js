...
export default class ApiService {
    ...
    static async createOrder(orderData) {
        const response = await axios.post(`${this.BASE_URL}/orders/create`, orderData, {
            headers: this.getHeader()
        });
        return response.data;
    }
    ...
    static async updateOrderStatus(orderId, status) {
        const response = await axios.put(`${this.BASE_URL}/orders/${orderId}/status`, null, {
            headers: this.getHeader(),
            params: { status }
        });
        return response.data;
    ...
    static async createShipment(shipmentData) {
        const response = await axios.post(`${this.BASE_URL}/shipments/create`, shipmentData, {
            headers: this.getHeader()
        });
        return response.data;
    }
    ...
    static async getAllShipments() {
        const response = await axios.get(`${this.BASE_URL}/shipments/all`, {
            headers: this.getHeader()
        });
        return response.data;
    }
    ...
    static async getShipmentById(shipmentId) {
        const response = await axios.get(`${this.BASE_URL}/shipments/${shipmentId}`, {
            headers: this.getHeader()
        });
        return response.data;
    }
    ...
    static async updateShipmentStatus(shipmentId, status) {
        const response = await axios.put(`${this.BASE_URL}/shipments/${shipmentId}/status`, null, {
            headers: this.getHeader(),
            params: { status }
        });
        return response.data;
    ...
    static async getDashboardMetrics() {
        const response = await axios.get(`${this.BASE_URL}/dashboard/metrics`, {
            headers: this.getHeader()
        });
        return response.data;
    }
